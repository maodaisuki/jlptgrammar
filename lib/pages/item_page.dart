                ...
                PopupMenuButton(
                      ...
                      showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content:
                                  Text("确认删除此条目？", style: TextStyle(fontSize: 18, color: themeConfig['textColor'])),
                              actions: <Widget>[
                                MaterialButton(
                  ...
                  itemBuilder: (BuildContext context) {
                    return [
                      ...
                      PopupMenuItem(value: 2, child: Text("分享", style: TextStyle(color: themeConfig['textColor']))),
                      const PopupMenuItem(value: 3, child: Text("删除", style: TextStyle(color: Colors.red))),
                    ];
                  },
                ),
              ],
                    ...
                    child: RepaintBoundary(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            color: themeConfig['backgroundColor'],
                            padding: const EdgeInsets.only(left: 11, top: 5, right: 11, bottom: 20),
                            alignment: Alignment.topLeft,
                            child: Text(
                  ...
                  child: Row(
                    children: [
                      RawChip(
                        ...
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(0), side: const BorderSide(color: Colors.transparent)),
                        backgroundColor: themeConfig['themeColor'],
                        padding: const EdgeInsets.all(2),
                        selected: false,
                      )
